...
(function (global, factory) {
   ...
   * @static
   * @param {Object} [options] Options object.
   * @param {Function} [options.compare] Function used to compare hierarchy of heading elements.
   * @param {string} [options.root='body'] CSS selector to scope the search of headings.
   * @param {string} [options.selector='h1,h2,h3,h4,h5,h6'] CSS selector to search for headings.
   * @param {string} [options.target='[simpletoc]'] CSS selector to seach for the element where the TOC is going to be attached.
  ...
  function domToc() {
    ...
    return _removeChildren(document.querySelector(target)).appendChild(domList_1(tree_1(Array.from(document.querySelector(root).querySelectorAll(selector)), compare), options));
  }
